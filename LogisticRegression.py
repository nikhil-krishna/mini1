...
# scatter_matrix(wine_df[wine_df.columns[0:6]])
# plt.xticks(fontsize=5)
# plt.yticks(fontsize=5)
# plt.show()
#
# scatter_matrix(wine_df[wine_df.columns[6:13]])
# plt.xticks(fontsize=5)
# plt.yticks(fontsize=5)
# plt.show()
...
print(k_fold_CV(wine_df_copy, lr_wine, 5, 0.001, 10)) # 0.7254565047021944
